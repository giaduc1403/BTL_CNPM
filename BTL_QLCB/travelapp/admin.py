...
from travelapp import admin, db, dao
from travelapp.models import HangMayBay, SanBay, TuyenBay, ChuyenBay, SanBayDung, BangDonGia, NguoiDung, HangVe, VeChuyenBay, \
    UserRole
...
admin.add_view(SanBayDungModelView(SanBayDung, db.session, name='Sân bay trung gian'))
