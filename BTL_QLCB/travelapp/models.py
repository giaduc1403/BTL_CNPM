...
if __name__ == '__main__':
    with app.app_context():
        ...
        v1 = HangVe(ten='Hạng VIP')
        v2 = HangVe(ten='Hạng Thường')
        ...
        u1 = NguoiDung(ten='Duc', taikhoan='admin', matkhau=password, loainguoidung=UserRole.ADMIN,
                        anhdaidien='https://res.cloudinary.com/dfzvtpwsd/image/upload/v1670221889/2_pzciij.png')
        u2 = NguoiDung(ten='Duy', taikhoan='staff', matkhau=password, loainguoidung=UserRole.STAFF,
                        anhdaidien='https://res.cloudinary.com/dfzvtpwsd/image/upload/v1670221889/3_gpownw.png')
        u3 = NguoiDung(ten='Trinh', taikhoan='user', matkhau=password, loainguoidung=UserRole.USER,
                        anhdaidien='https://res.cloudinary.com/dfzvtpwsd/image/upload/v1670221889/1_beeily.png')
        db.session.add_all([u1, u2, u3])
        db.session.commit()
        s1 = SanBay(ten='Đà Lạt')
        ...
        c1 = ChuyenBay(giodi=datetime.strptime('12/19/24 13:55:00', '%m/%d/%y %H:%M:%S'), thoigianbay=30,
                        hangmaybay_ma=1, tuyenbay_ma=1)
        c2 = ChuyenBay(giodi=datetime.strptime('12/20/23 7:00:00', '%m/%d/%y %H:%M:%S'), thoigianbay=180,
                        hangmaybay_ma=2, tuyenbay_ma=2)
        c3 = ChuyenBay(giodi=datetime.strptime('12/20/23 9:35:00', '%m/%d/%y %H:%M:%S'), thoigianbay=70,
                        hangmaybay_ma=3, tuyenbay_ma=3)
        c4 = ChuyenBay(giodi=datetime.strptime('12/29/23 6:55:00', '%m/%d/%y %H:%M:%S'), thoigianbay=90,
                        hangmaybay_ma=4, tuyenbay_ma=4)
        c5 = ChuyenBay(giodi=datetime.strptime('12/25/23 19:55:00', '%m/%d/%y %H:%M:%S'), thoigianbay=120,
                        hangmaybay_ma=5, tuyenbay_ma=5)
        c6 = ChuyenBay(giodi=datetime.strptime('1/19/24 13:55:00', '%m/%d/%y %H:%M:%S'), thoigianbay=90,
                        hangmaybay_ma=3, tuyenbay_ma=1)
        c7 = ChuyenBay(giodi=datetime.strptime('12/20/23 7:00:00', '%m/%d/%y %H:%M:%S'), thoigianbay=180,
                        hangmaybay_ma=5, tuyenbay_ma=2)
        c8 = ChuyenBay(giodi=datetime.strptime('12/20/23 9:35:00', '%m/%d/%y %H:%M:%S'), thoigianbay=70,
                        hangmaybay_ma=1, tuyenbay_ma=1)
        c9 = ChuyenBay(giodi=datetime.strptime('12/29/23 6:55:00', '%m/%d/%y %H:%M:%S'), thoigianbay=90,
                        hangmaybay_ma=4, tuyenbay_ma=4)
        c10 = ChuyenBay(giodi=datetime.strptime('12/25/23 19:55:00', '%m/%d/%y %H:%M:%S'), thoigianbay=120,
        ...
        b1 = BangDonGia(hangve_ma=1, chuyenbay_ma=1, gia=1000000, soghe=8)
        b2 = BangDonGia(hangve_ma=2, chuyenbay_ma=1, gia=900000, soghe=1)
        b3 = BangDonGia(hangve_ma=1, chuyenbay_ma=2, gia=800000, soghe=5)
        b4 = BangDonGia(hangve_ma=1, chuyenbay_ma=3, gia=1300000, soghe=3)
        b5 = BangDonGia(hangve_ma=2, chuyenbay_ma=3, gia=1000000, soghe=2)
        b6 = BangDonGia(hangve_ma=1, chuyenbay_ma=4, gia=1000000, soghe=50)
        b7 = BangDonGia(hangve_ma=2, chuyenbay_ma=4, gia=1500000, soghe=60)
        b8 = BangDonGia(hangve_ma=1, chuyenbay_ma=5, gia=1000000, soghe=62)
        b9 = BangDonGia(hangve_ma=1, chuyenbay_ma=6, gia=1300000, soghe=48)
        b10 = BangDonGia(hangve_ma=2, chuyenbay_ma=7, gia=1000000, soghe=23)
        b11 = BangDonGia(hangve_ma=1, chuyenbay_ma=8, gia=1000000, soghe=35)
        b12 = BangDonGia(hangve_ma=2, chuyenbay_ma=9, gia=7500000, soghe=17)
        b13 = BangDonGia(hangve_ma=1, chuyenbay_ma=10, gia=1000000, soghe=27)
